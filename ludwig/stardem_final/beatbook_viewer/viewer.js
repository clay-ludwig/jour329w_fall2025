// Configuration - fixed paths to the embeddings_format/output directory
const beatbookFile = 'embeddings_format/output/beat_book.json';
const storiesFile = 'embeddings_format/output/source_stories.json';
...
function extractArticleContent(content) {
    ...
    // Exception for "U.S." - if we accidentally split "U.S.Department", rejoin it with a space
